...
#python test_main.py
#python test_main.py --test_classes Contrast_Detection_SpF_Gabor_Ach
#python test_main.py --test_classes Contrast_Detection_Area
#python test_main.py --test_classes Contrast_Detection_Luminance
#python test_main.py --test_classes Contrast_Masking_Phase_Coherent
#python test_main.py --test_classes Contrast_Masking_Phase_Incoherent
#python test_main.py --test_classes Contrast_Detection_SpF_Gabor_Ach Contrast_Detection_Area Contrast_Detection_Luminance Contrast_Masking_Phase_Coherent Contrast_Masking_Phase_Incoherent
